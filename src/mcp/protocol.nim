...
const
  CURRENT_VERSION* = MCPVersion(kind: VersionSemver, major: 1, minor: 0, patch: 0)  ## Current protocol version (2024-11-05)
  VERSION_20241105* = MCPVersion(kind: VersionSemver, major: 1, minor: 0, patch: 0)  ## Version 2024-11-05
